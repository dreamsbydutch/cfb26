...
| ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `GET /`             | Renders the responsive Michigan personnel explorer with six primary views. Its depth chart uses offense, defense, and special-teams tabs with continuous position tables grouped into starters, rotation, depth, first/second-season prospects, and walk-ons. Green, yellow, and red row backgrounds communicate the eligibility bands; jersey numbers lead each row, original recruiting years are prominent, and short-term, long-term, and season-ending injuries use distinct inline treatments. | `rosters.list`, `players.getProfile`, `seasonalStats.listBySeason`. |
