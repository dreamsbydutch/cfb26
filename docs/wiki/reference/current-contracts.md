...
| `/games`, `/national/*`            | Games, continuous complete-field Power, Résumé, deterministic Playoff, Teams/program profiles, Simulator, Blind Ballot, and Methodology. Games use fuzzy Eastern broadcast windows while retaining exact local kickoff times. The schedule has two game ratings: Landscape for nationally important, strong, close matchups, and Michigan for Wolverines schedule, rivalry, rank-band, conference, and shared-opponent relevance across the season. Upcoming games lead, followed by started games and past results. Completed games show final scores and winners; missing results remain explicitly pending. One responsive expandable row shows teams and kickoff or final score, with upcoming TV outlets visible. Power, interest scores, venue, and projections are in details. `/national/games` redirects to `/games`. |
