...
**Current source — approved and implemented 2026-09-06; hosted backend cutover 2026-09-07:** CFB26 is a Michigan-first college football intelligence system. It joins Michigan recruiting, roster, development, game, departure, draft, and NFL-career history with national team, schedule, rating, résumé, playoff, and matchup analysis. The Convex migration and production backend promotion are complete; web delivery remains a separate operation.
...
PFF is outside the product. Source no longer contains `SnapCounts.json`, the PFF preparation/import/read path, or PFF presentation. The controlled hosted migration deleted the legacy PFF rows after exact-target snapshots; nothing was relabeled to hide its origin. [ADR 0011](../decisions/0011-replace-pff-data-with-cfb26-player-grades.md) records the decision.
...
The weekly Games view has two separate game-interest ratings. Landscape prioritizes team quality and national stakes, with a bounded competitiveness bonus. Michigan prioritizes direct Wolverines games, rivals, Big Ten opponents, teams around or above Michigan in the rankings, and games involving Michigan’s past or future opponents.
...
**Current source:** [Three distinct ratings](../reference/three-team-ratings.md) separate durable Program health, predictive Power, and earned Résumé. Program combines ten seasons of results, acquisition, and development with earned accomplishments since 2000. Conference titles, playoff advancement, and national championships contribute explicit prestige credit through recent and legacy curves. Recent success matters most; consecutive exceptional seasons can establish a stronger results baseline through a bounded adjustment inside the same Program ranking. Older honors retain a bounded contribution. Brand recognition alone earns no points. Historical conference-title coverage remains limited to verified records and sourced title-game results.
...
- prior-season Program history, using the validated v4 feature, adds a one-time bonus of at most 0.15 win-equivalents after a win; current-season championship status affects qualification without a separate trophy bonus; and
