...
| --- | --- |
| `schema.ts` | Validated tables, null semantics, indexes, immutable outputs, source state, sessions, backups, and operation logs. |
...
- Require a verified backup before material Michigan operations.
